# This script prepares .apsimx files for ROTATION factorial simulations
...
#' 
#' 
apsimRotation <- function(country,useCaseName,Crops, AOI = FALSE, season=1,zone,level2=NA,pathIn_zone=T,expfile_name,clck,varietyids,rep,fix_crop_or_soil_parm) {
  Crop <- Crops[1]
