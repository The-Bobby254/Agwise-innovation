# Produce individual EXTE scatter plots and maps for best Sow Date and highest yields per location for ROTATION
...
#' Generate APSIM Rotation Plots for Crop Simulation Results
#'
#' This function processes APSIM simulation results for rotation and produces plots
